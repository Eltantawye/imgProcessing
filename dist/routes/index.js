...
routes.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, width, height, imagePath, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                imagePath = path_1.default.resolve("images/".concat(req.query.filename, ".jpg"));
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, resizeImage_1.resizeImage)(imagePath, filename, width, height)];
            case 3:
                //resize image function will generate a new image in thumbnails folder if image is not cached
                _a.sent();
                res.sendFile("".concat(exports.rootPath, "/thumbnails/").concat(filename, "_").concat(width, "_").concat(height, ".jpg"));
                return [3 /*break*/, 5];
            case 4:
                error_1 = _a.sent();
